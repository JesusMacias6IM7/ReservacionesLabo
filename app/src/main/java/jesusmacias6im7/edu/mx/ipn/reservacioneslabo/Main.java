...
public class Main extends Activity implements SeekBar.OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cuantasPersonas.setText("NUMERO DE PERSONAS: 1"); // condicion inicial
        ...
        grupoBotones = (RadioGroup) findViewById(R.id.grupoBotones);
        coctel = (Switch) findViewById(R.id.coctel);
        spinner = (Spinner) findViewById(R.id.decoracion);
    ...
    public void reserva(View v) {
        ...
        if(grupoBotones.getCheckedRadioButtonId() == 0)
        ...
        datos.putString("coctel", coctelText);
        datos.putString("decoracion", spinner.getSelectedItem().toString());
